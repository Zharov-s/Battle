(() => {
  ...
  function render(data){
    ...
    app.innerHTML=`<div class="dashboard"><div class="dragon-flight" aria-hidden="true"><img src="./assets/dragon-flight.png?v=1" alt=""></div><section class="hero"><article class="card hero-main hero-cinematic"><img class="hero-image" src="./assets/cities-battle-hero.png?v=1" alt="Два фэнтезийных города перед битвой"><div class="hero-title"><h1>Игры престолов.<span>Битва городов</span></h1></div><div class="theme-control">${themeSwitch()}</div></article></section>
    ...
    document.querySelector('.champion-personal img').src='./assets/champion-personal-king.png?v=1';
