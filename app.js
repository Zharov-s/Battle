(() => {
  ...
  function render(data){
    ...
    app.innerHTML=`<div class="dashboard"><section class="hero"><article class="card hero-main hero-cinematic"><img class="hero-image" src="./assets/casino-mafia-hero.png?v=1" alt="Интерьер мафиозного казино"><div class="hero-title"><h1>Казино мафии.<span>Битва городов</span></h1></div><div class="theme-control">${themeSwitch()}</div></article></section>
    ...
    document.querySelector('.champion-personal img').src='./assets/casino-personal-boss-v2.png?v=1';
